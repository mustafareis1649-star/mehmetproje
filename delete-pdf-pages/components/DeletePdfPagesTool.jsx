...
import { deletePdfPagesDicts } from "../i18n";
import { deletePdfPages, parsePageSelection, formatSize } from "../logic/deletePdfPages";
import { PDFDocument } from "pdf-lib";

export default function DeletePdfPagesTool() {
  const t = useToolI18n(deletePdfPagesDicts);
  ...
  async function handleDelete() {
    ...
    try {
      ...
      const { blob, fileName } = await deletePdfPages(file, pageIndices);
          ...
          <div className="pdf-ws-card">
            ...
            <div className="pdf-ws-footer">
              {result ? (
                ...
                <button className="btn btn-signal pdf-ws-primary" onClick={handleDelete} disabled={busy}>{busy ? t("deleting") : t("delete_btn")}</button>
              ) : null}
